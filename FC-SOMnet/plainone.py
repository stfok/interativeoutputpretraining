...
yin22 = tf.matmul(yin1, weightin3) + biasin3
...
'''
#gr1=[wwpin] #wwp
gr2=[weightin1,  weightin3, biasin1,  biasin3]#,weight2, bias2
gr3=[ weight1, bias1] 
...
train_op22 = tf.train.GradientDescentOptimizer(0.00).minimize(loss, var_list=gr3)
train2=tf.group( train_op21, train_op22) #

train_op21z = tf.train.GradientDescentOptimizer(0.0025).minimize(loss, var_list=gr2)
