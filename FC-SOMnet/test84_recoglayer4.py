...
y1_ = tf.cast(y11_, dtype=tf.float64)
#is_training=False, 
...
weightin2 = tf.Variable(tf.truncated_normal([6, 3], stddev=0.1,dtype=tf.float64))
...
yin22 = yin2#tf.matmul(yin20, weightin3) + biasin3
...
'''
gr1=[wwpin] #wwp
gr2=[weightin1, weightin2, biasin1, biasin2]#,weight2, bias2, biasin3, weightin3,
gr3=[ weight1, bias1] 
...
train_op21z = tf.train.GradientDescentOptimizer(0.0025).minimize(loss, var_list=gr2+gr3)
train_op22z = tf.train.GradientDescentOptimizer(0.0025).minimize(loss, var_list=gr1)
